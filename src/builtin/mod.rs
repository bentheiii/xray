...
pub(crate) fn load_builtin<W: Write, R: RngCore + SeedableRng, T: TimeProvider>(
    ...
    add_generator_windows(scope).unwrap();
    ...
    add_generic_debug(scope).unwrap();
    add_generic_error(scope).unwrap();
    add_generic_get_error(scope).unwrap();
    add_generic_if(scope).unwrap();
    add_generic_if_error(scope).unwrap();
    add_generic_if_error_specific(scope).unwrap();
    add_generic_is_error(scope).unwrap();
    add_generic_dyn_cast(scope).unwrap();
    add_generic_dyn_cmp_ge(scope).unwrap();
    add_generic_dyn_cmp_gt(scope).unwrap();
    add_generic_dyn_cmp_le(scope).unwrap();
    add_generic_dyn_cmp_lt(scope).unwrap();
    add_generic_dyn_contains(scope).unwrap();
    add_generic_dyn_count(scope).unwrap();
    add_generic_dyn_display(scope).unwrap();
    ...
    add_generic_dyn_ne(scope).unwrap();
    add_generic_dyn_partial(scope).unwrap();
    ...
    add_int_combination_with_replacement(scope).unwrap();
